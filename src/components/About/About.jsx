        ...
        <div className="mt-5 w-full h-fit md:h-dvh py-3">
            <div className="container justify-between flex flex-col md:flex-row lg:justify-between items-center h-full text-center md:text-left lg:text-left">
                ...
                < div className='w-full md:w-1/2 relative h-full flex flex-col justify-center'>
                    <img src={about1} alt="" className='md:w-[200px] lg:w-[300px] h-auto md:absolute lg:left-24 lg:top-0 hidden md:block' />
                    <img src={about2} alt="" className='md:w-[200px] lg:w-[300px] h-auto md:absolute right-0 -bottom-0 hidden md:block' />
                    <div className='md:absolute hidden md:block bottom-[20%] left-[200px] bg-white py-[20px] px-[20px] rounded-lg'>
                        <div className='flex flex-col text-center'>
